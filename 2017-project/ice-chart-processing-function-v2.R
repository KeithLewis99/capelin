...
## function for extracting egg attributes from EGG_ATTR string-----------------------------
#' Egg data Attributes
#'
...
## eggAttr.query - query the egg/ice data for concentration and stage ---------------
#'
...
#' Calculate Area and Volume of ice
#'
