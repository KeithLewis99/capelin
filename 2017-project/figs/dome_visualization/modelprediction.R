...
# read data ---------------------------------------------------------------
cap <- read.csv('vectors.csv', header = T, as.is = T)
...
zlabel <- 'ln(capelin biomass (ktons))'
...
# save plot ---------------------------------------------------------------
jpeg(filename = 'predicted_CSM3.jpg', res = 400, width = 177, height = 177, units = 'mm', quality = 100)
 print(predictedcap)
dev.off()
