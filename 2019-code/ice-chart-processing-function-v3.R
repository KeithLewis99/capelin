...
e00Download <- function(x){
  for(i in x) {
    ...
    #note that sometime in 2019 the "http" became "https": appears that this change applies to all files and is permanent
    #url.dir <- "http://ice-glaces.ec.gc.ca//www_archive/AOI_12/Coverages/"
    url.dir <- "https://ice-glaces.ec.gc.ca//www_archive/AOI_12/Coverages/"
